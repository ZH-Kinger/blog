...
- **访问 Grafana**： 浏览器输入 http://192.168.31.136:3000 (账号密码 admin/admin)。
- **添加二进制 Prometheus（核心步骤）**：
...
- **手动修改**：vi /usr/local/nginx/conf/nginx.conf。
- **语法检查**：/usr/local/nginx/sbin/nginx -t。
- **热加载生效**：/usr/local/nginx/sbin/nginx -s reload。
...
![](https://cdn.nlark.com/yuque/0/2026/png/62301513/1772700162327-e12e5e34-84da-4f6f-84b4-c0eb36dcef56.png)
<hr id="JVZ4Y" class="ne-hr">
