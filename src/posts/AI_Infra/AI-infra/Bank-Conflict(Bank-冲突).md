...
这是最经典也最暴力的解法。如果一个二维 Tile 块的原始宽度是 ![](https://cdn.nlark.com/yuque/__latex/a11ea46280669ac0bf8afdac4019d77f.svg)（这会让每一列的元素在物理上垂直对齐、死锁在同一个 Bank 空间中）。
