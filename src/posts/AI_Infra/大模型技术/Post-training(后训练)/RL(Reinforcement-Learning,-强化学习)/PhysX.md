...
在你的虚拟储物间里，有一把挂锁掉在了桌子上。PhysX 会在每一帧（比如 ![](https://cdn.nlark.com/yuque/__latex/6518f341596d83d31678d552c74011a5.svg) 秒）读取这把锁的质量（Mass）、惯性张量（Inertia Tensor，来自 URDF），并根据万有引力公式和它当前的速度，计算出下一帧它应该在什么位置、以什么角度翻滚。
