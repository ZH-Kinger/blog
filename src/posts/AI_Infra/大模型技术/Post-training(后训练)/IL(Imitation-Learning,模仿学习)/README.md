---
title: IL（Imitation Learning，模仿学习）
icon: server
date: 2026-07-13
order: 79
category:
...
![](https://cdn.nlark.com/yuque/0/2026/png/62301513/1780382071748-49ccfd92-4577-47c2-9730-68550a86b4ef.png)
...
- **数学本质：** 它把复杂的机器人控制直接降维成了一个监督学习（Supervised Learning）问题。给一张 ![](https://cdn.nlark.com/yuque/__latex/cead1760d9d5723460c4b8d4028f113a.svg) 时刻的 RGB 图片（状态 ![](https://cdn.nlark.com/yuque/__latex/79ce3c7a71877c2ff01695e38ade43ca.svg)），让人类专家给出当前的电机电流（动作 ![](https://cdn.nlark.com/yuque/__latex/26fdbf8e53cb0e48da5f4ddd4aaf5a5c.svg)）。神经网络（如 ResNet 或 Transformer）的任务就是最小化预测动作与人类动作之间的 L2 均方误差（MSE Loss）。
...
2. **IL 预训练 + RL 微调 (RLHF/RLAIF 路线)：**  
   这恰好对应了你们技术规划中的 `Realworld RL`。先用 IL 让人类数据把模型快速拉到一个“基本能看懂锁”的水平；然后把这个模型扔进 Isaac Lab，用 RL 在各种域随机化（摩擦力改变、重力改变）的折磨下，让它自己学会如何在出现微小偏差时“自我纠正”。
