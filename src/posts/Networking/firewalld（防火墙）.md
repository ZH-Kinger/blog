...
<hr id="q06Tz" class="ne-hr">
## 3. 防火墙与杀毒软件的区别

很多人会混淆这两者，但它们的职责完全不同：
<table id="Jg9PY" class="ne-table" style="width: 750px"><tbody><tr style="height: 33px"><td width="250">
**维度**
</td><td width="250">
**防火墙**
</td><td width="250">
**杀毒软件 (Endpoint Security)**
...
你家里的**私人医生/保洁**
</td></tr></tbody></table><hr id="freRs" class="ne-hr">
## 4. 常见的部署位置
