...
- 手写一个 get_cpu_usage() 函数。
- 构造 Prompt，告诉 AI：“你有一个工具叫 get_cpu_usage，请在需要时调用它”。
- 手动解析 AI 返回的 JSON，并运行函数返回结果给 AI。


- **目的：** 搞清楚框架到底在背后帮你做了什么。
<hr id="wezEy" class="ne-hr">
...
<hr id="lq1rx" class="ne-hr">
## 推荐学习资源清单


- **必看文档：**[Hugging Face Smolagents 教程](https://huggingface.co/docs/smolagents) (目前最干净、最好懂的 Agent 入门)。
- **必读论文：***ReAct: Synergizing Reasoning and Acting in Language Models* (了解 Agent 的起源)。
- **必追项目：** 在 GitHub 关注 **OpenClaw** 和 **LangGraph** 的更新。
<hr id="VeWHo" class="ne-hr">