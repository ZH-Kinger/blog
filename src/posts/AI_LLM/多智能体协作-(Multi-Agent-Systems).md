---
title: 多智能体协作 (Multi-Agent Systems)
icon: robot
date: 2026-03-16
category:
  - AI大模型
...
- **Shell Agent (Executor)**：执行 tail -n 50 /var/log/nginx/error.log。
- **安全 Agent (Reviewer)**：审核 Executor 准备执行的清理脚本，发现脚本里有 rm -rf /，立刻拦截并打回重写。
- **总结 Agent**：将所有过程汇总成周报发到你的微信。
<hr id="Y9B6a" class="ne-hr">
## 五、 梓涵的 AIOps 思考
