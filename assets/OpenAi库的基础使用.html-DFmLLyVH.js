import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,d as e,o as i}from"./app-2JOjse27.js";const l={};function p(t,s){return i(),a("div",null,[...s[0]||(s[0]=[e(`<p>学习 openai 库（Python 官方 SDK）是掌握 OpenAI API 核心能力的关键，它能让你轻松调用 GPT 系列模型、实现 Function Calling、构建 ReAct 智能体等。下面我会从<strong>基础入门 → 核心功能 → 高级实战 → 最佳实践</strong> 逐步讲解，全程用可运行的代码示例，新手也能快速上手。</p><hr id="JWkcd" class="ne-hr"> ## 一、前置准备 <h3 id="_1-环境安装" tabindex="-1"><a class="header-anchor" href="#_1-环境安装"><span>1. 环境安装</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span># 安装最新版 openai 库（注意：v1.x 版本和旧版 v0.x 接口差异较大，推荐用 v1+）</span></span>
